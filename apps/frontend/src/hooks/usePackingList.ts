...
import type { PackingCategory } from '@/services/trip.service';
...
function formatPackingList(destination: string, categories: PackingCategory[], checkedItems: Set<string>): string {
